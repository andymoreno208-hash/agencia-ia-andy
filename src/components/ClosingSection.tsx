      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-20 text-center animate-fade-in">
          <a
            ...
            className="animate-glow inline-flex w-full max-w-2xl items-center justify-center rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-500 px-10 py-6 text-center text-xl font-extrabold text-white transition-transform hover:scale-[1.02] sm:text-2xl"
          >
            Agendar Auditoría Técnica ($500)
          </a>
        </div>
