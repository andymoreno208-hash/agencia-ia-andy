        ...
        <div className="rounded-2xl border border-card-border bg-card-bg p-8 sm:p-12">
          ...
          <div className="mt-8 text-center">
            <a
              ...
              className="cta-primary animate-glow inline-flex items-center gap-2 rounded-full px-8 py-4 text-base font-semibold text-white transition-transform hover:scale-105"
            >
